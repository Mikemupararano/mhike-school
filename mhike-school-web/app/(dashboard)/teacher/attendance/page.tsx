...
export default function TeacherAttendanceRegisterPage() {
    ...
    const [autoLoadedEntryId, setAutoLoadedEntryId] = useState<number | null>(
        null,
    );
        ...
        async function loadTeacherTimetable() {
            try {
                ...
                const todaysEntries = data.filter(
                    (entry) => entry.day_of_week.toLowerCase() === todayName,
                );
    ...
    const loadExistingAttendanceRecords = useCallback(
    ...
    }, [loadExistingAttendanceRecords, selectedEntry]);
    ...
    useEffect(() => {
        ...
        if (autoLoadedEntryId === selectedEntry.id) {
            return;
        }
