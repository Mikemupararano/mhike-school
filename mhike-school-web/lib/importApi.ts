...
/**
 * Persist editable Import Wizard configuration for an uploaded batch.
 *
 * The backend only permits this operation while the batch has status
 * ``uploaded``. System-controlled fields are rejected by the backend schema.
 */
