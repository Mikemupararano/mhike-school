...
api_router.include_router(
    assessment_result_exports.router,
    prefix="/assessment-result-exports",
    tags=["assessment-result-exports"],
)
...
api_router.include_router(
    assessment_result_outcomes.router,
    prefix="/assessment-result-outcomes",
    tags=["assessment-result-outcomes"],
)
...
api_router.include_router(
    assessment_cohort_performance.router,
    prefix="/assessment-cohort-performance",
    tags=["assessment-cohort-performance"],
)


api_router.include_router(
    assessment_feedback.router,
    prefix="/assessment-feedback",
    tags=["assessment-feedback"],
)


api_router.include_router(
    assessment_targets.router,
    prefix="/assessment-targets",
